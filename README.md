...
Issues encountered and resolved during development, documented as a reference for MERN projects involving OAuth.

---

### 1. Spotify rejected `localhost` as a redirect URI
...
### 3. Session cookies not persisting across origins
...
### 4. Custom headers stripped by the Vite proxy
...
### 5. 413 Payload Too Large on Discogs batch request
...
### 6. Discogs checking all albums instead of just the current page
